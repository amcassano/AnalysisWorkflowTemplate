...
allgenes <- dplyr::select(allgenes, GeneID)
...
-   **PCA inputs**
    ...
    -   `varianceRemove` -\> defaults to 0.05 which removes lowest 5% of variables based on variance. If there are ~2000 genes then removing 75% would leave the top 500 genes to make the PCA from
