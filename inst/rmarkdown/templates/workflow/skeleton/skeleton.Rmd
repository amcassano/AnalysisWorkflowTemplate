...
) # change this if desired, be warned though if you add EntrezID you'll need to adjust things further down to reflec that
```
...
) # change this if you changed whats in the annotation
...
ranked_OneThree <- analyzeRNA::signif_deg(one_vs_three,
    padj_threshold,
    l2fc_threshold
)
```
...
```{r filtered_rlogdf}
#add any/all pairwise comparisons (not the ranked version) to the end of the function call
rlog_df <- analyzeRNA::filtered_rlog(p_thresh = 0.1, fc_thresh = 0.4, rlogdf = rlog_df, one_vs_two, two_vs_three)
```
...
grDevices::pdf(file = paste0(output_dir, "/PCA_analyses"))
...
```{r other_pca_code}
#if you *don't* want the images exported to pdf, comment the line below and the final line of the chunk out. You can change the size of the images if you'd like
grDevices::pdf(file = paste0(output_dir, "/DEseq_PCA"))

analyzeRNA::originalPCA(dseq_transform = rlog_norm,
                        plot_aes = plot_aes,
                        plot_title = "PCA",
                        label_samples = FALSE)
...
#if you *don't* want the images exported to pdf, comment the line below and the final line of the chunk out. You can change the size of the images if you'd like
grDevices::pdf(file = paste0(output_dir, "/UMAP"))


set.seed(5)
rlogUMAP <- umap_analysis(
...
#if you *don't* want the images exported to pdf, comment the line below and the final line of the chunk out. You can change the size of the images if you'd like
grDevices::pdf(file = paste0(output_dir, "/plot_counts"))
...
#if you *don't* want the images exported to pdf, comment the line below and the final line of the chunk out. You can change the size of the images if you'd like
grDevices::pdf(file = paste0(output_dir, "/volcano_plots"))
...
#if you *don't* want the images exported to pdf, comment the line below and the final line of the chunk out. You can change the size of the images if you'd like
grDevices::pdf(file = paste0(output_dir, "/comp_volcanoplot"))
...
This should use the ranked dataframes
...
This should use ranked dataframes.
You will need to input a list of the MGI symbols in each ranked dataframe and assign it a name (see examples below).
...
```{r venn_diagrams}
#if you *don't* want the images exported to pdf, comment the line below and the final line of the chunk out. You can change the size of the images if you'd like
grDevices::pdf(file = paste0(output_dir, "/venndiagrams"))

two_comp_venndiagram <- plot_venndiagram(list("One" = ranked_OneThree, "Two" = ranked_TwoThree), 
                                         plt_title = "# DEGs shared vs. Three",
                                         edgecolor = c(group1_color, group2_color),
                                         showintersects = TRUE)

three_comp_venndiagram <- plot_venndiagram(list("One" = ranked_OneThree, 
                                                "Two" = ranked_TwoThree, 
                                                "Four" = ranked_FourThree), 
                                         plt_title = "# DEGs shared vs. Three",
...
overlaps_onetwo_vsthree <- venn_overlaps(list("One" = ranked_OneThree, "Two" = ranked_TwoThree))

overlaps_onetwofour_vsthree <- venn_overlaps(list("One" = ranked_OneThree, 
                                                "Two" = ranked_TwoThree, 
                                                "Four" = ranked_FourThree))
```
...
one_vs_two_GSEA <- go_GSEA(degs = one_vs_two, pval_cutoff = 0.05, ontol = "BP")
one_vs_two_ORA <- go_ORA(deg_df = one_vs_two, pval_cutoff = 0.05, ontol = "BP")
...
setwd(output_dir)
export_genelist(one_vs_two_GSEAresults, "One_vs_two_GSEA_results")
```
...
#if you *don't* want the images exported to pdf, comment the line below and the final line of the chunk out. You can change the size of the images if you'd like
grDevices::pdf(file = paste0(output_dir, "/GSEA_dot_plots"))
...
#if you *don't* want the images exported to pdf, comment the line below and the final line of the chunk out. You can change the size of the images if you'd like
grDevices::pdf(file = paste0(output_dir, "/GSEA_ridge_plots"))
...
#if you *don't* want the images exported to pdf, comment the line below and the final line of the chunk out. You can change the size of the images if you'd like
grDevices::pdf(file = paste0(output_dir, "/GSEA_cluster_plots"))

gseClusterPlot <- makeGSEplot(
    GSE_obj = one_vs_two_GSEA,
    plot_title = "1 vs 2 GSEA",
    plot_type = "cluster"
)
...
#if you *don't* want the images exported to pdf, comment the line below and the final line of the chunk out. You can change the size of the images if you'd like
grDevices::pdf(file = paste0(output_dir, "/GSEA_heat_plots"), width = 50)

gseHeatPlot <- makeGSEplot(
    GSE_obj = one_vs_two_GSEA,
    plot_title = "1 vs 2 GSEA",
    plot_type = "heat"
)
...
#if you *don't* want the images exported to pdf, comment the line below and the final line of the chunk out. You can change the size of the images if you'd like
grDevices::pdf(file = paste0(output_dir, "/GSEA_upset_plots"))

gseUpsetPlot <- makeGSEplot(
    GSE_obj = one_vs_two_GSEA,
    plot_title = "1 vs 2 GSEA",
    plot_type = "upset"
)
...
#if you *don't* want the images exported to pdf, comment the line below and the final line of the chunk out. You can change the size of the images if you'd like
grDevices::pdf(file = paste0(output_dir, "/GSEA_tree_plots"), height = 12)

gseTreePlot <- makeGSEplot(
    GSE_obj = one_vs_two_GSEA,
    plot_title = "1 vs 2 GSEA",
    plot_type = "tree"
)
...
#if you *don't* want the images exported to pdf, comment the line below and the final line of the chunk out. You can change the size of the images if you'd like
grDevices::pdf(file = paste0(output_dir, "/GSEA_trad_plots"))

gseTradPlot <- makeGSEplot(
    GSE_obj = one_vs_two_GSEA,
    plot_title = "1 vs 2 GSEA",
...
#if you *don't* want the images exported to pdf, comment the line below and the final line of the chunk out. You can change the size of the images if you'd like
grDevices::pdf(file = paste0(output_dir, "/GSEA_category_plots"))

catplot <- categorynetplot(
...
```{r revigo}
#if you *don't* want the images exported to pdf, comment the line below and the final line of the chunk out. You can change the size of the images if you'd like
grDevices::pdf(file = paste0(output_dir, "/GSEA_revigo_plots"))
...
#if you *don't* want the images exported to pdf, comment the line below and the final line of the chunk out. You can change the size of the images if you'd like
grDevices::pdf(file = paste0(output_dir, "/heatmaps"))
...
cellprolif <- consolidate_gene_list(
    map = gmap,
...
top_genes <- rbind(
    dplyr::slice_head(ranked_OneTwo, n = 15) %>% dplyr::select(MGI_Symbol),
    dplyr::slice_head(ranked_TwoThree, n = 15) %>% dplyr::select(MGI_Symbol)
)
top_genes <- dplyr::distinct(top_genes, MGI_Symbol, .keep_all = TRUE)

top_heatmap <- heatmapFromDF(
...
#if you *don't* want the images exported to pdf, comment the line below and the final line of the chunk out. You can change the size of the images if you'd like
grDevices::pdf(file = paste0(output_dir, "/go_group_heatmaps"))

go_groups2 <- goGrouping(one_vs_two, pval_cutoff = 0.05, l2fc_cutoff = 0.45, lvl = 2) %>% tibble::remove_rownames()

go_groups3 <- goGrouping(one_vs_two, pval_cutoff = 0.05, l2fc_cutoff = 0.45, lvl = 3) %>% tibble::remove_rownames()

go_groups4 <- goGrouping(one_vs_two, pval_cutoff = 0.05, l2fc_cutoff = 0.45, lvl = 4) %>% tibble::remove_rownames()

#get the genes in any of these go groups by the row number.

f <- genelistFromGOGroup(go_groups3, 1)
