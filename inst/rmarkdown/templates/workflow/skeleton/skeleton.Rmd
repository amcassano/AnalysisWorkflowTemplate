...
*Built with R version 4.3.1. Most recent template changes made on May 22, 2024*
...
The `pairwiseDEGresults` function calls the DESeq2 package's `results` function.
...
p <- analyzeRNA::get_pca_obj(rlog_df, meta, 0.25)
PCAtools::screeplot(p)

# see what is contributing to each PC
