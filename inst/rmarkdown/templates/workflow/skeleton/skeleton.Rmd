...
For OE analysis, if you use GO (gene ontology) database you're good to go with the ensembl id (gene id column).
...
```{r over_representation, eval=TRUE}
one_vs_two_ORA <- go_ORA(one_vs_two, ontol = "BP")
...
```{r get_gsea, eval=TRUE}

one_vs_two_GSEA <- go_GSEA(degs = one_vs_two,
                           ontol = "BP")

one_vs_twoFC <- getFoldChange(one_vs_two)
```
