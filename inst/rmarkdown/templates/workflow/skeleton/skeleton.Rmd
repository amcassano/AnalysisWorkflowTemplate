...
-   **Export function inputs**
    ...
    -   `filename` -\> required; string; the name of the file to export to, it will be exported to your output dir set above, do not include ".csv" that will be added automatically, if you're exporting only up- or down-regulated genes that will be added to the file name automatically as well
...
From <https://revigo.irb.hr/> - this code will help you see what similar pathways are represented in your GSEA data
