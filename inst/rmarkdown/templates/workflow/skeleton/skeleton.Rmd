...
two_comp_venndiagram <- analyzeRNA::plot_venndiagram(list("One" = sig_OneThree, "Two" = sig_TwoThree),
                                         plt_title = "# DEGs shared vs. Three",
                                         edgecolor = c(group1_color, group2_color),
                                         showintersects = TRUE)

three_comp_venndiagram <- analyzeRNA::plot_venndiagram(list("One" = sig_OneThree,
                                                "Two" = sig_TwoThree,
                                                "Four" = sig_FourThree),
                                         plt_title = "# DEGs shared vs. Three",
...
overlaps_onetwo_vsthree <- analyzeRNA::venn_overlaps(list("One" = sig_OneThree, "Two" = sig_TwoThree))

overlaps_onetwofour_vsthree <- analyzeRNA::venn_overlaps(list("One" = sig_OneThree,
                                                "Two" = sig_TwoThree,
                                                "Four" = sig_FourThree))
```
